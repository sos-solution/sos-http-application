...
class Smarty3 extends Adapter
{
    ...
    public function __construct($config) {
        ...
        $smarty->setTemplateDir($config['view']['viewsDir']);
        $smarty->setCompileDir($config['view']['cacheDir']);
        $smarty->setCacheDir($config['view']['cacheDir']);
