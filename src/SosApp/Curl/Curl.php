...
namespace SosApp\Curl;

use SosApp\Curl\ArrayUtil;
use SosApp\Curl\Decoder;
...
class Curl
{
    ...
    {
        $this->jsonDecoder = 'SosApp\Curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = 'SosApp\Curl\Decoder::decodeXml';
    }
    ...
    public function setDefaultDecoder($mixed = 'json')
    {
        if ($mixed === false) {
            ...
            if ($mixed === 'json') {
                $this->defaultDecoder = 'SosApp\Curl\Decoder::decodeJson';
            } elseif ($mixed === 'xml') {
                $this->defaultDecoder = 'SosApp\Curl\Decoder::decodeXml';
            }
        }
    }
